...
from privacy_policy_analyzer.utils import token_to_ent, token_to_ent_id, chunk_to_conjuncts, token_to_source

Token.set_extension("src", getter=token_to_source)
